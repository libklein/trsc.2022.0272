...
option(${PROJECT_NAME}_ENABLE_ASAN "Enable ASAN." OFF)
...
# Python bindings
option(${PROJECT_NAME}_ENABLE_PYTHON_BINDINGS "Build python bindings using pyside11." ON)
# Allow callbacks
option(${PROJECT_NAME}_ENABLE_CALLBACKS "Call callbacks registered from python" OFF)

# Profile mode
option(${PROJECT_NAME}_ENABLE_PROFILE "Enable Profiling." OFF)

# Safety (bounds) checking
option(${PROJECT_NAME}_ENABLE_SAFETY_CHECKS "Enable additional safety checks, e.g., bounds checking for PWL functions." OFF)
option(${PROJECT_NAME}_ENABLE_EXTENSIVE_SAFETY_CHECKS "Enable additional (expensive) safety checks, e.g., bounds checking for PWL functions." OFF)
option(${PROJECT_NAME}_WARN_EXTENSIVE_SAFETY_CHECKS "Do not throw when (expensive) safety checks fail." OFF)
