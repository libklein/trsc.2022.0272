...
namespace ska {
    ...
    namespace detailv8 {
        ...
        template<typename T, typename FindKey, typename ArgumentHash, typename Hasher, typename ArgumentEqual,
            typename Equal, typename ArgumentAlloc, typename ByteAlloc, uint8_t BlockSize>
    ...
    class bytell_hash_set
        : public detailv8::sherwood_v8_table<T, T, H, detailv8::functor_storage<size_t, H>, E,
              detailv8::functor_storage<bool, E>, A, typename std::allocator_traits<A>::template rebind_alloc<unsigned char>,
